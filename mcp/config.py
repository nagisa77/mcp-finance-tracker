...
DEFAULT_CATEGORIES = [
    ...
    {
        "name": "电子产品",
        "description": "购买手机、电脑等电子设备的费用",
        "color": "#A3BE8C",
        "type": "expense",
    },
    {
        "name": "房租水电",
        "description": "房屋租金与水电煤等杂费",
        "color": "#EBCB8B",
        "type": "expense",
    },
    {
        "name": "外出就餐",
        "description": "在餐厅等外面吃饭的消费",
        "color": "#D08770",
        "type": "expense",
    },
    {
        "name": "周末游玩",
        "description": "周末娱乐、电影、聚会等花销",
        "color": "#B48EAD",
        "type": "expense",
    },
    {
        "name": "旅行",
        "description": "长途或短途旅行的全部花销",
        "color": "#7CC6FE",
        "type": "expense",
    },
    {
        "name": "网络订阅",
        "description": "各类互联网订阅服务，如视频网站、音乐等",
        "color": "#95E1D3",
        "type": "expense",
    },
    {
        "name": "便利店",
        "description": "便利店的小额消费",
        "color": "#FFD6A5",
        "type": "expense",
    },
    {
        "name": "Drinks",
        "description": "饮品、咖啡、奶茶等相关消费, 以及网购买酒等",
        "color": "#FFB4A2",
        "type": "expense",
    },
    {
        "name": "出行",
        "description": "交通、打车、地铁、公交等相关费用",
        "color": "#BDE0FE",
        "type": "expense",
    },
    {
        "name": "宠物",
        "description": "宠物相关的费用，如宠物食品、医疗等",
        "color": "#CDB4DB",
        "type": "expense",
    },
    {
        "name": "医疗",
        "description": "医疗相关的费用，如看病、药品等",
        "color": "#F4A259",
        "type": "expense",
    },
    {
        "name": "人情开销",
        "description": "人情往来、送礼等费用",
        "color": "#C0D9AF",
        "type": "expense",
    },
    {
        "name": "娱乐",
        "description": "娱乐相关的费用，如电影、演唱会、游戏、网吧等",
        "color": "#9C89B8",
        "type": "expense",
    },
    {
        "name": "工资",
        "description": "固定工资及奖金收入",
        "color": "#34D399",
        "type": "income",
    },
    {
        "name": "其他收入",
        "description": "除工资与副业外的其他收入来源",
        "color": "#60A5FA",
        "type": "income",
    },
    {
        "name": "副业",
        "description": "副业、副职或兼职带来的收入",
        "color": "#FBBF24",
        "type": "income",
    },
]
